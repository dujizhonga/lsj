...
public class MMember {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId())
				.append("telephone", getTelephone()).append("sex", getSex()).append("birthday", getBirthday())
				.append("qq", getQq()).append("qqId", getQqId()).append("wechat", getWechat()).append("wxId", getWxId())
				.append("nickname", getNickname()).append("appVersion", getAppVersion())
				.append("lockFlag", getLockFlag()).append("withdrawalPassword", getWithdrawalPassword())
				.append("password", getPassword()).append("email", getEmail()).append("registerTime", getRegisterTime())
				.append("lastLoginTime", getLastLoginTime()).append("inviteCode", getInviteCode())
				.append("loginTelType", getLoginTelType()).append("loginType", getLoginType())
				.append("lastLoginIp", getLastLoginIp()).append("headImg", getHeadImg())
				.append("registerType", getRegisterType()).append("oilsBalance", getOilsBalance())
				.append("oilsRechargeBalance", getOilsRechargeBalance()).append("gasBalance", getGasBalance())
				.append("etcBalance", getEtcBalance()).append("settleQuota", getSettleQuota())
				.append("settleBalance", getSettleBalance()).append("freezingAmount", getFreezingAmount())
				.append("amountUsed", getAmountUsed()).append("presentAmount", getPresentAmount())
				.append("totalRecharge", getTotalRecharge()).append("totalLoaning", getTotalLoaning())
				.append("totalSettle", getTotalSettle()).append("rechargeBalance", getRechargeBalance())
				.append("loaningBalance", getLoaningBalance()).append("credit", getCredit())
				.append("integral", getIntegral()).append("realName", getRealName()).append("address", getAddress())
				.append("driverAuthStatus", getDriverAuthStatus()).append("personalAuthStatus", getPersonalAuthStatus())
				...
				.append("carOwnerIssuedStatus", getCarOwnerIssuedStatus()).append("isUpdate", getIsUpdate())
				.append("isLsjData", getIsLsjData()).append("freezingAmountWithdrawals", getFreezingAmountWithdrawals())
				.toString();
	}
}
