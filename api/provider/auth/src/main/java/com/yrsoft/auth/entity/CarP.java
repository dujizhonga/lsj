...
/** 禁用状态（0：启用，1禁用） */
private Integer openStop=0;
/** 是否佬司机原有数据（0：是 ，1：否） */
private Integer isLsjData=1;
/** 备案状态（0.未备案 1.已备案） */
...
/** ETC 状态  (0:未开通 1：已开通) */
private Integer etcState=0;
/** 删除状态(0：未删除，1：已删除) */
private Integer deleteFlag=0;


//司机/车主信息
private String nickname="";//司机/车主昵称
private String realName="";//司机/车主昵称
private String telephone="";//司机/车主电话
private String lng="";//车辆坐标经度
private String lat="";//车辆坐标纬度
...
public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
	            ...
	            .append("driver1Id", getDriver1Id())
	            .append("driver2Id", getDriver2Id())
	            .append("ownerName", getOwnerName())
	            .append("carNumber", getCarNumber())
	            .append("runCertificateImg", getRunCertificateImg())
	            .append("runCertificateImg2", getRunCertificateImg2())
	            .append("transportCertificateImg", getTransportCertificateImg())
	            .append("carTypeName", getCarTypeName())
	            .append("fuelType", getFuelType())
	            .append("setupWeight", getSetupWeight())
	            .append("towWeight", getTowWeight())
	            .append("totalTractionWeight", getTotalTractionWeight())
	            ...
	            .append("transportLicense", getTransportLicense())
