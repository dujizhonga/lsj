...
public String toString() {
	return "CarInfoVO [id=" + id + ", memberId=" + memberId + ", driver1Id=" + driver1Id + ", driver2Id=" + driver2Id
			...
			+ businessLicense + ", transportLicense=" + transportLicense + ", carVin=" + carVin + ", status=" + status
			+ ", createTime=" + createTime + ", newFlag=" + newFlag + ", checkTime=" + checkTime + ", checkUser="
			+ checkUser + ", description=" + description + ", isSys=" + isSys + ", runStatus=" + runStatus
			+ ", openStop=" + openStop + ", isLsjData=" + isLsjData + ", recordState=" + recordState + ", registerTime="
			+ registerTime + ", carType=" + carType + ", etcState=" + etcState + ", deleteFlag=" + deleteFlag
			+ ", nickname=" + nickname + ", telephone=" + telephone + ", lng=" + lng + ", lat=" + lat + "]";
}
