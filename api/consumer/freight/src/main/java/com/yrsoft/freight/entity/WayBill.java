...
public class WayBill implements Serializable{
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("id", getId())
				.append("waybillNumber", getWaybillNumber()).append("invoiceId", getInvoiceId())
				.append("carId", getCarId()).append("freightId", getFreightId()).append("insuranceId", getInsuranceId())
				.append("advanceFreight", getAdvanceFreight()).append("actualFreight", getActualFreight())
				...
				.append("modifyCause", getModifyCause()).append("poundsImg1", getPoundsImg1())
				.append("poundsImg2", getPoundsImg2()).append("poundsNum1", getPoundsNum1())
				.append("poundsNum2", getPoundsNum2()).append("createTime", getCreateTime())
				.append("deliveryTime", getDeliveryTime()).append("deliveryGoodsTime", getDeliveryGoodsTime())
				.append("confirmReceiptTime", getConfirmReceiptTime()).append("flag", getFlag())
				.append("isCancel", getIsCancel()).append("waybillState", getWaybillState())
				.append("storedState", getStoredState()).append("freightPayState", getFreightPayState())
				.append("freightPayWay", getFreightPayWay()).append("insurancePayState", getInsurancePayState())
				.append("isComments", getIsComments()).append("star", getStar()).append("comment", getComment())
				.append("evaluateOptions", getEvaluateOptions()).append("receiptStatus", getReceiptStatus())
