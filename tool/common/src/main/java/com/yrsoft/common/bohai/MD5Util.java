...
public class MD5Util {
	...
	// F, G, H ,I
	// 是4个基本的MD5函数，在原始的MD5的C实现中，由于它们是简单的位运算，可能出于效率的考虑把它们实现成了宏，在java中，我们把它们实现成了private方法，名字保持了原来C中的。
	...
	public static String toMD5(String source) {
		...
		String str = md5.getMD5ofStr(source).toLowerCase();
		str = str.replace("e", "1");
		String tmp1 = str.substring(2, str.length() - 3);
		String tmp2 = str.substring(10, 15);
		return tmp1 + tmp2;
	}
   ...
   /** 
    ...
    public static String encryptionTo32Bit(String plainText) { 
	...
	public static void main(String[] args) {
		System.out.println(MD5Util.encryptionTo32Bit("nickname=问我&userId=9&api_name=updateNickname"));
		System.out.println(MD5Util.getMD5("nickname=张三&userId=8&api_name=updateNickname"));
	}
