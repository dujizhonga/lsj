package com.yrsoft.common.json;
...
public class JSONObject extends LinkedHashMap<String, Object>
{
     ...
     * @param <T>
     * @return
     * @throws NullParamException paramStr 为空
     */
    public static <T> T paramStrToBean(String paramStr,Class<T> beanClass) throws NullParamException{
        if (StringUtils.isEmpty(paramStr)) {
            throw new NullParamException(201,"参数不能为空");
        }
        return JSONUtil.toBean(paramStr,beanClass);
    }

    /**
     * jsonString 转 bean 可选忽略错误
     * @author Yhq
     * @param paramStr
     * @param beanClass
     * @param ignoreError 是否忽略转化参数错误
     * @param <T>
     * @return
     * @throws NullParamException paramStr 为空
     */
    public static <T> T paramStrToBean(String paramStr,Class<T> beanClass, boolean ignoreError) throws NullParamException{
        if (StringUtils.isEmpty(paramStr)) {
            throw new NullParamException(201,"参数不能为空");
        }
        return JSONUtil.toBean(JSONUtil.parseObj(paramStr),beanClass,ignoreError);
    }
}
